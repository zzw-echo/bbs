			...
			<div class="modal-dialog" role="document">
				<div class="modal-content col-md-11">
					<div class="modal-header">
						...
						<h3 class="modal-title text-center" id="exampleModalLabel">写下你要发布的手链信息</h3>
                        <!--<p class="text-center">具有创新的手链更易得到关注和评论</p> -->
						<p class="text-center text-danger">需知：你所发布的手链信息需要通过管理员审核通过后才能在首页展示</p>
					</div>
					<div class="modal-body">
						<form action="${APP_PATH }/articleController/setArticle" method="post" enctype="multipart/form-data">
							...
							<p class="text-muted">手链图片<span class="text-danger"></span></p>
							<div class="form-group">
								<div id="f_preview">
									<a href="#">
