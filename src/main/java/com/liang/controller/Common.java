...
public class Common {
	...
	public String getAll(Map<Object, Object> map,Map<Object, Object> map2) {
		...
		/*手链达人*/
		List<Article> articlePerson=articleService.getArticlePerson();
		map.put("articlePerson", articlePerson);
	...
	public void addAgree(HttpServletRequest request,Map<Object, Object> map,Map<Object, Object> map2) {
		String pid=request.getParameter("pid");
		//更新点赞个数
		commentService.updateComment(pid);
		getAll(map,map2);
	}
